    ...
    <div class="fixed inset-0 bg-black bg-opacity-30 z-40 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-3xl shadow-lg flex flex-col w-full max-w-sm sm:max-w-md md:max-w-3xl lg:max-w-5xl h-full max-h-[90vh] p-4 gap-4">
            ...
            <div class="flex flex-col md:flex-row flex-grow gap-4">
                <!-- Sección del Mapa -->
                <div ref="mapDiv" class="flex-grow md:w-2/3 h-full rounded-2xl overflow-hidden min-h-[250px] md:min-h-0"></div>

                <!-- Sección de Detalles de la Placa - Diseño Mejorado -->
                <div class="md:w-1/3 p-6 bg-white border border-gray-200 rounded-2xl flex flex-col overflow-y-auto shadow-sm">
                    ...
                    <div v-if="slabData" class="space-y-4 text-gray-700 flex-grow">
                        ...
                        <!-- Latitud -->
                        <div class="flex items-center gap-3">
                            <!-- Icono de ubicación para Latitud -->
                        ...
                        <!-- Longitud -->
                        <div class="flex items-center gap-3">
                            <!-- Icono de ubicación para Longitud -->
                        ...
                        <!-- Dimensiones -->
                        <div class="flex items-center gap-3">
                            <!-- Icono de regla para Dimensiones -->
                        ...
                        <div v-if="slabData.pathologies && slabData.pathologies.length > 0"
                            ...
                            <ul class="list-none space-y-2 text-sm text-gray-700">
                                <!-- Mostramos las primeras 5 patologías con un icono -->
                                ...
                                <!-- Indicador de más patologías si las hay -->
                    ...
                    <div v-else class="text-center text-gray-500 p-4">
                        <!-- Icono de carga o documento si los datos no están disponibles -->
...
<style scoped>
/* No se requiere CSS adicional si estás usando Tailwind CSS para todo. */
</style>
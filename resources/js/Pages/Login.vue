    ...
    <section class="bg-white flex items-center justify-center h-full w-full">
      <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img alt="" :src="fondo1" class="absolute inset-0 h-full w-full object-cover opacity-80" />
          ...
          <div class="hidden lg:relative lg:block lg:p-12">
            ...
            <p class="mt-4 leading-relaxed text-white/90">
              Diapce es una plataforma que centra sus esfuerzos en la gestión de proyectos, permitiendo a los usuarios crear, organizar y supervisar sus iniciativas de manera eficiente.
            </p>
          </div>
        </section>
